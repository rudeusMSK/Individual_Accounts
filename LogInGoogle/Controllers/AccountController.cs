            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    if (!mdUser.EmailConfirmed)
                    {
                        ...
                        return View("NotifcationEmailConfirm");
                    }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    string emailBody = System.IO.File.ReadAllText(HttpContext.Server.MapPath("~/HTML/RudeusMSK/NewMessage2.html"));
                    // await UserManager.SendEmailAsync(user.Id, "Confirm your account", "Please confirm your account by clicking <a href=\"" + callbackUrl + "\">here</a>");
                    SendMail.SendEmail(user.Email, "Confirm your account", emailBody + $@"<a href= ""{ callbackUrl}"" >here !</a>", "");
